...
func uniqueChannelAffinityUsageCacheTestKey(prefix string) string {
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_ClaudeMode(t *testing.T) {
	ruleName := uniqueChannelAffinityUsageCacheTestKey("rule")
	usingGroup := "default"
	keyFP := uniqueChannelAffinityUsageCacheTestKey("fp")
