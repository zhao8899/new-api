...
func InitOptionMap() {
	...
	common.OptionMap[ChannelHealthCircuitModeOption] = NormalizeChannelHealthCircuitMode(common.GetEnvOrDefaultString(channelHealthCircuitModeEnv, channelHealthCircuitModeObserve))
